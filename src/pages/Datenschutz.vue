<template>
  <div class="w-full p-10 text-center">
    ...
    <div class="px-5 rounded overflow-hidden shadow-lg">
      <h2 class="mt-2 text-xl">1. Datenschutz auf einen Blick</h2>
      <h3 class="mt-2 text-lg font-bold">Allgemeine Hinweise</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Datenerfassung auf dieser Website</h3>
      <h4 class="font-bold">
      ...
      <h4 class="font-bold">Wof&uuml;r nutzen wir Ihre Daten?</h4>
      <p class="mt-2">
        Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
        Website zu gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse
        Ihres Nutzerverhaltens verwendet werden.
      </p>
      <h4 class="font-bold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
      <p class="mt-2">
      ...
      <h2 class="mt-2 text-xl">2. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
      <h3 class="mt-2 text-lg font-bold">Datenschutz</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Hinweis zur verantwortlichen Stelle</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Speicherdauer</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Auskunft, Berichtigung und L&ouml;schung</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
      <p class="mt-2">
      ...
      <h3 class="mt-2 text-lg font-bold">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
      <p class="mt-2">
